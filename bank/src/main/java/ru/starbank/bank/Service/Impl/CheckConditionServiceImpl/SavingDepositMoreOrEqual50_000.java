...
@Qualifier("SavingDepositMoreOrEqual50_000")
@Component
public class SavingDepositMoreOrEqual50_000 implements CheckConditionService {

    private final JdbcTemplate jdbcTemplate;

    private final RecommendationsRepository recommendationsRepository;

    public SavingDepositMoreOrEqual50_000(JdbcTemplate jdbcTemplate, RecommendationsRepository recommendationsRepository) {
