...
public class StaticRecommendationDBInitializer {
    ...
    private static final String TOPSAVINGTEXT = "Откройте свою собственную «Копилку» с нашим банком! " +
    ...
    private static final String SIMPLELOANTEXT = "Откройте мир выгодных кредитов с нами!\n" +
            "\n" +
